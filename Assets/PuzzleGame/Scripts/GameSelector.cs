...
{
    [SerializeField]
    GamePresetsList gamePresetsList;
    [SerializeField]
    BoostersPanel boostersPanel;
    [SerializeField]
    BoosterButton boosterPrefab;
    [SerializeField]
    RectTransform boostersParent;
    [SerializeField]
    Button boostersBlocker;
    ...
    [SerializeField]
    GameOverAds gameOver;

    [SerializeField]
    int highlightSortingOrder;

    int currentGameIndex;
    BaseGameController currentGame;
    
    Toggle[] toggles;
    private List<BoosterButton> boosters = new List<BoosterButton>();
    ...
    void UpdateBoosters()
    {
        ...
        for (int i = 0; i < gamePresetsList.presets[currentGameIndex].boosters.Length; i++)
        {
            BoosterButton booster = Instantiate(boosterPrefab, boostersParent);
            booster.Init(gamePresetsList.presets[currentGameIndex].boosters[i], highlightSortingOrder);
